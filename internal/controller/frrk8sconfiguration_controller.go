...
type FRRK8sConfigurationReconciler struct {
	...
	FRRK8sConfigurationName string
}
...
func (r *FRRK8sConfigurationReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	currentLogLevel, err := getLogLevel(ctx, r, r.Namespace, r.FRRK8sConfigurationName, r.DefaultLogLevel)
	if err != nil {
...
func getLogLevel(ctx context.Context, r client.Reader, namespace, frrK8sConfigurationName string,
	defaultLogLevel logging.Level) (logging.Level, error) {
	config := frrk8sv1beta1.FRRK8sConfiguration{}
	if err := r.Get(ctx, types.NamespacedName{Namespace: namespace, Name: frrK8sConfigurationName}, &config); err != nil {
