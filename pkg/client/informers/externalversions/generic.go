...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1beta1.SchemeGroupVersion.WithResource("frroperatorconfigurations"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Api().V1beta1().FRROperatorConfigurations().Informer()}, nil
