...
func (c *FakeFRRConfigurations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.FRRConfiguration, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(frrconfigurationsResource, c.ns, name), &v1beta1.FRRConfiguration{})
...
func (c *FakeFRRConfigurations) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.FRRConfigurationList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(frrconfigurationsResource, frrconfigurationsKind, c.ns, opts), &v1beta1.FRRConfigurationList{})
...
func (c *FakeFRRConfigurations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(frrconfigurationsResource, c.ns, opts))
...
func (c *FakeFRRConfigurations) Create(ctx context.Context, fRRConfiguration *v1beta1.FRRConfiguration, opts v1.CreateOptions) (result *v1beta1.FRRConfiguration, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(frrconfigurationsResource, c.ns, fRRConfiguration), &v1beta1.FRRConfiguration{})
...
func (c *FakeFRRConfigurations) Update(ctx context.Context, fRRConfiguration *v1beta1.FRRConfiguration, opts v1.UpdateOptions) (result *v1beta1.FRRConfiguration, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(frrconfigurationsResource, c.ns, fRRConfiguration), &v1beta1.FRRConfiguration{})
...
func (c *FakeFRRConfigurations) UpdateStatus(ctx context.Context, fRRConfiguration *v1beta1.FRRConfiguration, opts v1.UpdateOptions) (*v1beta1.FRRConfiguration, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(frrconfigurationsResource, "status", c.ns, fRRConfiguration), &v1beta1.FRRConfiguration{})
...
func (c *FakeFRRConfigurations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(frrconfigurationsResource, c.ns, listOpts)
...
func (c *FakeFRRConfigurations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.FRRConfiguration, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(frrconfigurationsResource, c.ns, name, pt, data, subresources...), &v1beta1.FRRConfiguration{})
