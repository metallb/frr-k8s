...
func (c *FakeApiV1beta1) FRROperatorConfigurations(namespace string) v1beta1.FRROperatorConfigurationInterface {
	return &FakeFRROperatorConfigurations{c, namespace}
}
