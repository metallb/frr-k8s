...
func main() {
	...
	go func() {
		...
		setupWebhook(mgr)
		startNodeStateCleaner(mgr, params.namespace, params.frrk8sSelector,
			controller.FRRK8sConfigurationName, defaultLogLevel)
	}()
...
func startNodeStateCleaner(mgr manager.Manager, namespace, frrk8sSelector string,
	frrK8sConfigurationName string, defaultLogLevel logging.Level) {
	...
	if err = (&controller.FRRK8sConfigurationReconciler{
		...
		Namespace:               namespace,
		FRRK8sConfigurationName: frrK8sConfigurationName,
