...
var (
	metricsTmpl = `
	# HELP frrk8s_bgp_announced_prefixes_total Number of prefixes currently being advertised on the BGP session
	# TYPE frrk8s_bgp_announced_prefixes_total gauge
	frrk8s_bgp_announced_prefixes_total{peer="{{ .NeighborIP }}", vrf="{{ .NeighborVRF }}"} {{ .AnnouncedPrefixes }}
	# HELP frrk8s_bgp_keepalives_received Number of BGP keepalive messages received
	# TYPE frrk8s_bgp_keepalives_received counter
	frrk8s_bgp_keepalives_received{peer="{{ .NeighborIP }}", vrf="{{ .NeighborVRF }}"} {{ .KeepalivesReceived }}
	# HELP frrk8s_bgp_keepalives_sent Number of BGP keepalive messages sent
	# TYPE frrk8s_bgp_keepalives_sent counter
	frrk8s_bgp_keepalives_sent{peer="{{ .NeighborIP }}", vrf="{{ .NeighborVRF }}"} {{ .KeepalivesSent }}
	# HELP frrk8s_bgp_notifications_sent Number of BGP notification messages sent
	# TYPE frrk8s_bgp_notifications_sent counter
	frrk8s_bgp_notifications_sent{peer="{{ .NeighborIP }}", vrf="{{ .NeighborVRF }}"} {{ .NotificationsSent }}
	# HELP frrk8s_bgp_opens_received Number of BGP open messages received
	# TYPE frrk8s_bgp_opens_received counter
	frrk8s_bgp_opens_received{peer="{{ .NeighborIP }}", vrf="{{ .NeighborVRF }}"} {{ .OpensReceived }}
	...
	# HELP frrk8s_bgp_session_up BGP session state (1 is up, 0 is down)
	# TYPE frrk8s_bgp_session_up gauge
	frrk8s_bgp_session_up{peer="{{ .NeighborIP }}", vrf="{{ .NeighborVRF }}"} {{ .SessionUp }}
	# HELP frrk8s_bgp_total_received Number of total BGP messages received
	# TYPE frrk8s_bgp_total_received counter
	frrk8s_bgp_total_received{peer="{{ .NeighborIP }}", vrf="{{ .NeighborVRF }}"} {{ .TotalReceived }}
	# HELP frrk8s_bgp_total_sent Number of total BGP messages sent
	# TYPE frrk8s_bgp_total_sent counter
	frrk8s_bgp_total_sent{peer="{{ .NeighborIP }}", vrf="{{ .NeighborVRF }}"} {{ .TotalSent }}
	# HELP frrk8s_bgp_updates_total Number of BGP UPDATE messages sent
	# TYPE frrk8s_bgp_updates_total counter
	frrk8s_bgp_updates_total{peer="{{ .NeighborIP }}", vrf="{{ .NeighborVRF }}"} {{ .UpdatesTotal }}
	# HELP frrk8s_bgp_updates_total_received Number of BGP UPDATE messages received
	# TYPE frrk8s_bgp_updates_total_received counter
	frrk8s_bgp_updates_total_received{peer="{{ .NeighborIP }}", vrf="{{ .NeighborVRF }}"} {{ .UpdatesTotalReceived }}
	`
