...
func (in *L2VNI) DeepCopyInto(out *L2VNI) {
	*out = *in
	in.VNIBase.DeepCopyInto(&out.VNIBase)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VNIBase) DeepCopyInto(out *VNIBase) {
	*out = *in
	if in.ImportRTs != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VNIBase.
func (in *VNIBase) DeepCopy() *VNIBase {
	if in == nil {
		return nil
	}
	out := new(VNIBase)
